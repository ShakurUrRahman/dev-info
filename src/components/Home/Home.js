        ...
        <div className="hero min-h-screen" style={{ backgroundImage: `url("dev-info.jpg")` }}>
            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="flex flex-col ">
                    ...
                    <p className="mb-5 text-[#F7E018] lg:mx-24 mx-3">We made for you some topics wise quizzes. You can go through it and sharp your knowledge by this. Please choose your section and by clicking the start button.</p>
